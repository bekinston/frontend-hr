                ...
                <div className="col s12">
                    <div className="container">
                        <div className="col s6">
                            <p className="footer-left-content">Join A Group community and start your successful career with us today! Here you will find experienced friendly atmosphere and develop yourself!</p>
                        </div>
                        <div className="col s6">
